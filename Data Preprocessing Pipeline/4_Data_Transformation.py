...
DATA_PATH = ""
    ...
    def transform_date_format(
        ...
        【操作的轉型原理與直覺本質】
        電腦看不懂「2026/06/14」、「14-Jun-26」或是「2026.06.14」這三種寫法是指同一天。
        我們需要透過 pd.to_datetime()，翻譯成標準的系統時間戳記。

        【統計/計量考量】
        在Time Series 或 Panel Data 模型中，時間是非常重要的。
        1. 計算時間差 ，例如：算出購買與退貨間隔了幾天。
        2. 進行時間維度的聚合，例如：自動將日資料按月或按季加總 
